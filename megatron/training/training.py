...
def num_floating_point_operations(args, batch_size):
    ...
    def transformer_flops():
        ...
        # pnglu (PolyNorm GLU) and xprglu are also GLUs (fc1 is h->2*ffn_h), so they count as gated
        # even though they do not set args.swiglu.
        ffn_expansion_factor = 3 if (args.swiglu or args.pnglu or args.xprglu) else 2
    ...
    if is_hybrid_model(args):
        ...
        return hybrid_flops(
            ...
            swiglu=args.swiglu or args.pnglu or args.xprglu,  # pnglu/xprglu are GLUs but do not set args.swiglu
            moe_latent_size=args.moe_latent_size,
